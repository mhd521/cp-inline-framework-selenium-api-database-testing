...
public class WaitHelper {
    ...
    public void waitWith30SecondAndClickElement(WebElement element){
        log.info("waiting for :" + element.toString() + " for :" + 30 + " seconds");
        WebDriverWait wait = getWait(30, 5);
        wait.until(ExpectedConditions.visibilityOf(element));
        log.info("element is visible now");
        JavaScriptHelper jh = new JavaScriptHelper(driver);
        jh.hightligtandCLick(element);
    }
    /**
    ...
    public void waitUntilTextAppear(WebElement element, String s1, int timeOutInSeconds){
        log.info("waiting for :" + element.toString() + " for :" + timeOutInSeconds + " seconds");
        WebDriverWait wait = new WebDriverWait(driver, timeOutInSeconds);
        wait.until(ExpectedConditions.textToBePresentInElement(element,s1));
        log.info("Text is visible now");
